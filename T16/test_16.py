...
class CNN(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv2d(3,64,kernel_size=(3,3),padding=1) # 第一卷积层
        self.bn1 = nn.BatchNorm2d(num_features=64)
        self.conv2 = nn.Conv2d(64,128,kernel_size=(3,3),padding=1) # 第二卷积层
    ...
    def forward(self,x):
        ...
        x = self.bn1(x)  # 归一化
        x = F.leaky_relu(x) # 激活
        x = F.avg_pool2d(x,2,stride=2) # 池化
